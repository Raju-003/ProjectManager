...
const COLORS = ['#8D51FF', '#00B8DB', '#7BCED0'];
  ...
  return (
    <DashboardLayout activeMenu="Dashboard">
      ...
      <div className="card p-6 md:p-8 mb-8 bg-white shadow-sm rounded-lg">
        <h2 className="text-xl md:text-2xl font-semibold text-gray-800">Welcome, {user?.name}</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="card p-6 bg-white shadow-sm rounded-lg">
          <h5 className="font-medium text-center text-gray-700 mb-5">Task Distribution</h5>
        ...
        <div className="md:col-span-2 card p-6 bg-white shadow-sm rounded-lg">
          <div className="flex items-center justify-between mb-5">
            <h2 className="text-lg md:text-xl font-semibold text-gray-800">Recent Tasks</h2>
            <button className="card-btn flex items-center text-primary hover:text-primary-dark" onClick={onSeeMore}>
