...
<div className="container mx-auto px-4 py-20 pt-20 flex flex-col md:flex-row items-center gap-10">
  <div className="md:w-1/2 space-y-6">
    ...
    <p className="text-lg text-gray-600 animate-fadeInUp animation-delay-200">
      ...
      and complete work efficiently. Our visual collaboration platform combines powerful kanban boards, 
      task management, and real-time communication to keep your projects moving forward.
    </p>
    <p className="text-gray-600 animate-fadeInUp animation-delay-300">
      Join over 10,000 teams who have streamlined their workflows and increased productivity by 
    ...
    <div className="flex items-center gap-2 text-sm text-gray-500 animate-fadeInUp animation-delay-500">
  ...
  <div className="container mx-auto px-4">
    <div className="text-center max-w-3xl mx-auto mb-16">
      ...
      <p className="text-gray-600">
        Project Vista combines all the tools your team needs to plan, execute, and deliver successful projects.
        Whether you're managing a small team or coordinating across departments, we've got you covered.
      </p>
    </div>
    <div className="grid md:grid-cols-3 gap-8">
      <div className="bg-gray-50 rounded-xl p-6 shadow-md hover:shadow-lg transition duration-300">
        ...
        <p className="text-gray-600 mb-4">
          Transform your workflow with customizable kanban boards that make project status immediately visible.
      ...
      <div className="bg-gray-50 rounded-xl p-6 shadow-md hover:shadow-lg transition duration-300">
        ...
        <p className="text-gray-600 mb-4">
          Break down silos with built-in communication tools. Comment on tasks, @mention teammates,
          and share files without leaving the platform.
        </p>
        <ul className="text-sm text-gray-500 space-y-1">
          <li className="flex items-center">
      ...
      <div className="bg-gray-50 rounded-xl p-6 shadow-md hover:shadow-lg transition duration-300">
        ...
        <p className="text-gray-600 mb-4">
          Our intelligent timeline view helps you spot bottlenecks before they happen.
          Automatic reminders keep everyone accountable for their deliverables.
        </p>
        <ul className="text-sm text-gray-500 space-y-1">
          <li className="flex items-center">
